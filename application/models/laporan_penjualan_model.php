...
class Laporan_penjualan_model extends CI_MODEL
{
    function get($data_filter = null, $data_date = null)
    {
        ...
        if ($data_filter == null && $data_date == null) {
            $this->db->select('penjualan.id_penjualan,penjualan.no_transaksi,penjualan.tanggal,customer.nama,barang.kode,barang.nama as nama_barang,penjualan.jumlah,penjualan.harga,user.nama as nama_user');
